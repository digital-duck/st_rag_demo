...
class DocumentChatbot:
    ...
    def build_vectorstore(self):
        ...
        # --- Start Modification ---
        # Log chunking stats for debugging - Access private attributes directly
        try:
            chunk_size_setting = self.text_splitter._chunk_size
            chunk_overlap_setting = self.text_splitter._chunk_overlap
        except AttributeError:
            # Fallback if attributes somehow don't exist
            chunk_size_setting = "N/A"
            chunk_overlap_setting = "N/A"
